...
class QtGearSpeedWidget(BaseQtHudWidget):
    ...
    def paint(
        ...
        # 2. Vitesse en km/h avec lissage LERP
        ...
        speed_font = QFont(self.font_family, speed_font_size, QFont.Weight.Bold)
        painter.setFont(speed_font)
        painter.setPen(QPen(QColor(255, 255, 255, 255)))
        painter.drawText(QRectF(0, speed_y, canvas_w, speed_font_size + 10), Qt.AlignmentFlag.AlignHCenter | Qt.AlignmentFlag.AlignTop, speed_str)

        # 4. Rapport de boîte (Gear) en dessous
        gear_font = QFont(self.font_family, gear_font_size, QFont.Weight.Bold)
        painter.setFont(gear_font)
        painter.setPen(QPen(QColor(255, 255, 255, 255)))
        painter.drawText(QRectF(0, 58.0 * scale_y, canvas_w, gear_font_size + 20), Qt.AlignmentFlag.AlignHCenter | Qt.AlignmentFlag.AlignTop, gear_str)
