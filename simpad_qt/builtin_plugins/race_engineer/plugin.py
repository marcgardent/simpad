"""
SimPad Plugin — Virtual Race Engineer & Sub-Plugins Orchestrator.
...
# =============================================================================
# Main Race Engineer SimPad Plugin
# =============================================================================
...
class RaceEngineerPlugin(
    ...
    def __init__(self):
        super().__init__(PluginMetadata(
            id="simpad.builtin.race_engineer",
    ...
    def get_channel_requirements(self) -> List[ChannelRequirement]:
        ...
        Exposes the merged desiderata to SimPad PluginManager and GamePluginManager.
        """
