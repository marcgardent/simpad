"""
SimPulse SDK — Declarative Configurable Parameters for Roles & Subplugins.
Provides type descriptors for parameters (BoolParam, IntRangeParam, FloatRangeParam, ChoiceParam).
SOLID architecture (SRP, OCP, LSP).
"""

## TODO MGT Exposer que des abstractions pas d'implémentations concrètes
## TODO MGT Changer de noms car utilisé pour d'autre cas que Roles Race Engineer
