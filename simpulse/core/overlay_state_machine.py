"""
SimPulse Qt6 Overlay State Machine & Contextual Visibility Engine.
...
from simpulse.core.game_process_watcher import GameStatus, GameFocusState
from simpulse.core.telemetry import VehicleSensors


logger = logging.getLogger("simpulse.overlay_state_machine")
