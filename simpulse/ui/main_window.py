"""
SimPulse Qt6 Main Studio Window.
...
from simpulse.core.game_process_watcher import GameProcessWatcher, GameStatus
...
class SimPulseMainWindow(QMainWindow):
    """Main Studio Console Window for SimPulse."""
    ...
    def __init__(
        ...
        self.overlay_window = SimPulseHudOverlayWindow(self.plugin_manager)
