"""
SimPulse Qt6 Core Footer Status Bar.
...
from simpulse.core.overlay_state_machine import OverlayStateMachine, GameSceneState, OverlayDisplayMode, OverlayStateSnapshot
...
class SimPulseCoreStatusBar(QStatusBar):
    """
    ...
    def _init_widgets(self) -> None:
        ...
        self.lbl_host_msg = QLabel("SimPulse Core Stack Initialized", self)
