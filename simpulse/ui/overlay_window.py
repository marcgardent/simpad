"""
SimPulse Qt6 Transparent Always-On-Top HUD Overlay Compositor Window.
...
logger = logging.getLogger("simpulse.overlay")
_PROJECT_ROOT = Path(__file__).resolve().parent.parent.parent


class SimPulseHudOverlayWindow(QWidget):
    """
    ...
    def __init__(self, plugin_manager: PluginManager, parent: Optional[QWidget] = None):
        ...
        self.setWindowTitle("SimPulse HUD Overlay")
    ...
    def _load_custom_font(self) -> str:
        ...
        font_path = _PROJECT_ROOT / "simpulse" / "builtin_plugins" / "official_cockpit_hud" / "fonts" / "Anta-Regular.ttf"
